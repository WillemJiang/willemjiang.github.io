...
### 会议信息：
* 会议时间： 周三 北京时间晚上9点，
* 会议链接： https://unomaha.zoom.us/j/720431288

### 其他相关信息：
* TWITTER: https://twitter.com/chaossproj:
* YOUTUBE: https://www.youtube.com/channel/UCrG-a3hIc_hCEUWloG0gm9A : 可以查看想的工作组的信息 
* CHAOSS Mailing list: https://lists.linuxfoundation.org/mailman/listinfo/chaoss

### 会议纪要 

### October 7, 2020

Video: https://youtu.be/ycDYly9IJZI 

#### 会议纪要
* 讨论了InnerSource相关的Metrics信息， Matt 提供了一个描述项目在大的生态环境中关系的metrics
   * Possible Metric: Position of this project in a larger ecosystem 
       * https://www.youtube.com/watch?v=gfzWQUDyLAI  
       * State of the Source 2020: How (and Why) to Identify your Critical OSS Dependencies, Julia Ferraioli 
           * Security  
           * Sustainability  
           * Stability (upstream fixes)

* 同时 Daniel 也提供了很多 InnerSource Common virtual summit 有关InnerSource和Metrics相关的内容
   * Agustín Benito Bethencourt - Daimler Group - https://youtu.be/lBcs97RgsAw?t=279
   * Brittany Istenes - Comcast, https://youtu.be/RenQ8B7aX84?t=485 
* 另外在[InnerSource Patterns](https://github.com/InnerSourceCommons/InnerSourcePatterns)中也有一些和metrics相关的内容： 
   * https://github.com/InnerSourceCommons/InnerSourcePatterns/blob/master/patterns/1-initial/introducing-metrics-in-innersource.md
   * https://github.com/InnerSourceCommons/InnerSourcePatterns/blob/master/patterns/2-structured/maturity-model.md
...
Video:https://youtu.be/8w5HGiFmZgk 
...
5. 内源启航 -- 参考 http://innersourcecommons.org/resources/books/ 
